...
class RelativeWindowsPathTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function containsData()
    {
        ...
        return array(
            ...
            'Middle with drive'                    => array('C:foo/bar/baz.qux', 'BAR/BAZ',     false,          true),
            'Suffix with drive'                    => array('C:foo/bar/baz.qux', '/BAZ.QUX',    false,          true),
            ...
            'Middle anchored'                      => array('/foo/bar/baz.qux',  'BAR/BAZ',     false,          true),
            'Suffix anchored'                      => array('/foo/bar/baz.qux',  '/BAZ.QUX',    false,          true),
    ...
    public function endsWithData()
    {
        ...
        return array(
            ...
            'Self with drive'                      => array('C:.',               '',          false,          true),
            'Prefix with drive'                    => array('C:foo/bar/baz.qux', 'c:FOO/BAR', false,          false),
            'Middle with drive'                    => array('C:foo/bar/baz.qux', 'BAR/BAZ',   false,          false),
            'Suffix with drive'                    => array('C:foo/bar/baz.qux', '/BAZ.QUX',  false,          true),
            'Not found with drive'                 => array('C:foo/bar/baz.qux', 'DOOM',      false,          false),
            ...
            'Self anchored'                        => array('/.',                '',          false,          true),
            'Prefix anchored'                      => array('/foo/bar/baz.qux',  '/FOO/BAR',  false,          false),
            'Middle anchored'                      => array('/foo/bar/baz.qux',  'BAR/BAZ',   false,          false),
            'Suffix anchored'                      => array('/foo/bar/baz.qux',  '/BAZ.QUX',  false,          true),
            'Not found anchored'                   => array('/foo/bar/baz.qux',  'DOOM',      false,          false),
    ...
    public function matchesData()
    {
        ...
        return array(
            ...
            'Prefix with drive'                      => array('C:foo/bar/baz.qux',  'c:FOO/BAR*',  false,          null,          true),
            'Middle with drive'                      => array('C:foo/bar/baz.qux',  '*BAR/BAZ*',   false,          null,          true),
            'Suffix with drive'                      => array('C:foo/bar/baz.qux',  '*/BAZ.QUX',   false,          null,          true),
            'Surrounding with drive'                 => array('C:foo/bar/baz.qux',  'c:FOO*.QUX',  false,          null,          true),
            'Single character with drive'            => array('C:foo/bar/baz.qux',  '*B?R*',       false,          null,          true),
            'Single character no match with drive'   => array('C:foo/bar/baz.qux',  '*F?X*',       false,          null,          false),
            'Set with drive'                         => array('C:foo/bar/baz.qux',  '*BA[RZ]*',    false,          null,          true),
            'Set no match with drive'                => array('C:foo/bar/baz.qux',  '*BA[X]*',     false,          null,          false),
            'Negated set with drive'                 => array('C:foo/bar/baz.qux',  '*BA[!RX]*',   false,          null,          true),
            'Negated set no match with drive'        => array('C:foo/bar/baz.qux',  '*BA[!RZ]*',   false,          null,          false),
            'Range with drive'                       => array('C:foo/bar/baz.qux',  '*BA[A-R]*',   false,          null,          true),
            'Range no match with drive'              => array('C:foo/bar/baz.qux',  '*BA[S-Y]*',   false,          null,          false),
            'Negated range with drive'               => array('C:foo/bar/baz.qux',  '*BA[!S-Y]*',  false,          null,          true),
            'Negated range no match with drive'      => array('C:foo/bar/baz.qux',  '*BA[!R-Z]*',  false,          null,          false),
            'No partial match with drive'            => array('C:foo/bar/baz.qux',  'BAR',         false,          null,          false),
            'Not found with drive'                   => array('C:foo/bar/baz.qux',  'DOOM',        false,          null,          false),
            ...
            'Prefix anchored'                        => array('/foo/bar/baz.qux',   '/FOO/BAR*',   false,          null,          true),
            'Middle anchored'                        => array('/foo/bar/baz.qux',   '*BAR/BAZ*',   false,          null,          true),
            'Suffix anchored'                        => array('/foo/bar/baz.qux',   '*/BAZ.QUX',   false,          null,          true),
            'Surrounding anchored'                   => array('/foo/bar/baz.qux',   '/FOO*.QUX',   false,          null,          true),
            'Single character anchored'              => array('/foo/bar/baz.qux',   '*B?R*',       false,          null,          true),
            'Single character no match anchored'     => array('/foo/bar/baz.qux',   '*F?X*',       false,          null,          false),
            'Set anchored'                           => array('/foo/bar/baz.qux',   '*BA[RZ]*',    false,          null,          true),
            'Set no match anchored'                  => array('/foo/bar/baz.qux',   '*BA[X]*',     false,          null,          false),
            'Negated set anchored'                   => array('/foo/bar/baz.qux',   '*BA[!RX]*',   false,          null,          true),
            'Negated set no match anchored'          => array('/foo/bar/baz.qux',   '*BA[!RZ]*',   false,          null,          false),
            'Range anchored'                         => array('/foo/bar/baz.qux',   '*BA[A-R]*',   false,          null,          true),
            'Range no match anchored'                => array('/foo/bar/baz.qux',   '*BA[S-Y]*',   false,          null,          false),
            'Negated range anchored'                 => array('/foo/bar/baz.qux',   '*BA[!S-Y]*',  false,          null,          true),
            'Negated range no match anchored'        => array('/foo/bar/baz.qux',   '*BA[!R-Z]*',  false,          null,          false),
            'No partial match anchored'              => array('/foo/bar/baz.qux',   'BAR',         false,          null,          false),
            'Not found anchored'                     => array('/foo/bar/baz.qux',   'DOOM',        false,          null,          false),
    ...
    public function testJoinFailureDriveMismatch()
    {
        ...
        $this->expectException(__NAMESPACE__ . '\Exception\DriveMismatchException');
        $path->join($joinPath);
    }
    ...
    public function testToAbsoluteFailureNoDrive()
    {
        ...
        $this->expectException('Eloquent\Pathogen\Exception\InvalidPathStateException');
        $path->toAbsolute();
    }
